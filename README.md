...
* [HTTP Debugging and Logging](https://llm.datasette.io/en/stable/http-debugging.html)
  ...
  * [What Gets Logged](https://llm.datasette.io/en/stable/http-debugging.html#what-gets-logged)
    * [Level 1 (`LLM_HTTP_DEBUG=1`)](https://llm.datasette.io/en/stable/http-debugging.html#level-1-llm-http-debug-1)
    * [Level 2 (`LLM_HTTP_DEBUG=2`)](https://llm.datasette.io/en/stable/http-debugging.html#level-2-llm-http-debug-2)
