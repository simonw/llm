...
class TestBuildMessagesConversationHistory:
    ...
    def test_no_double_emission_from_conversation_prompt_flow(
        ...
        sent_body = json.loads(httpx2_mock.get_requests()[-1].content)
...
class TestStreamingExecuteYieldsStreamEvents:
    def test_text_stream_yields_text_events(self, httpx2_mock):
        httpx2_mock.add_response(
            method="POST",
            url="https://api.openai.com/v1/chat/completions",
    ...
    def test_text_stream_plain_iteration_still_returns_strings(self, httpx2_mock):
        httpx2_mock.add_response(
            method="POST",
            url="https://api.openai.com/v1/chat/completions",
            stream=IteratorStream(_text_stream()),
    ...
    def test_text_stream_messages_assembled(self, httpx2_mock):
        httpx2_mock.add_response(
            method="POST",
            url="https://api.openai.com/v1/chat/completions",
            stream=IteratorStream(_text_stream()),
    ...
    def test_tool_call_stream_yields_name_and_args_events(self, httpx2_mock):
        httpx2_mock.add_response(
            method="POST",
            url="https://api.openai.com/v1/chat/completions",
    ...
    def test_tool_call_registered_via_add_tool_call(self, httpx2_mock):
    ...
    def test_text_then_tool_call_part_index_advances(self, httpx2_mock):
        httpx2_mock.add_response(
            method="POST",
            url="https://api.openai.com/v1/chat/completions",
...
class TestAsyncStreamingExecuteYieldsStreamEvents:
    @pytest.mark.asyncio
    async def test_text_stream_yields_text_events(self, httpx2_mock):
        httpx2_mock.add_response(
            method="POST",
            url="https://api.openai.com/v1/chat/completions",
            stream=IteratorStream(_text_stream()),
...
class TestReasoningTokenCount:
    def test_redacted_reasoning_part_emitted_when_count_present(self, httpx2_mock):
        httpx2_mock.add_response(
            method="POST",
            url="https://api.openai.com/v1/chat/completions",
    ...
    def test_no_reasoning_part_when_zero_or_absent(self, httpx2_mock):
        httpx2_mock.add_response(
            method="POST",
            url="https://api.openai.com/v1/chat/completions",
