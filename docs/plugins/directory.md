...
- **[llm-apple](https://github.com/btucker/llm-apple)** adds access to Apple's on-device [Foundation models](https://developer.apple.com/documentation/FoundationModels)
