...
- **[llm-azure-api-embed](https://github.com/orangewise/llm-azure-api-embed)** generate embeddings using deployments on [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service)
