...
- **[llm-venice](https://github.com/ar-jan/llm-venice)** provides access to uncensored models hosted by privacy-focussed [Venice AI](https://docs.venice.ai/), including Llama 3.1 405B.
