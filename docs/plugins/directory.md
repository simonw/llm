...
- **[llm-zai-glm](https://github.com/irthomasthomas/llm-zai-glm)** supports [Z.AI](https://z.ai/)'s GLM models, including glm-5.2 and glm-5.2-coding with thinking-effort and preserved reasoning support via the Coding Plan endpoints.
